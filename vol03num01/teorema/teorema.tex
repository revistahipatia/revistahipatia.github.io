...
\begin{thebibliography}{9} \vspace{.5cm}
    ...
    \bibitem{Caicedo} {Caicedo, A., {\em 580
    ...
    \bibitem{Kunen} Kunen, K., {\em Set
    theory -- An introduction to
    independence proofs}. Studies in Logic
    and the Foundations of Mathematics, 102,
    North-Holland Publishing Co., Amsterdam,
    1983, xvi+313 pp.
    \bibitem{Levy} L\'evy, A., {\em Basic
    Set Theory}, Springer-Verlag, Berlin-New
    York, 1979, xiv+391 pp.
    \bibitem{Sierp}{Sierpiński, W.
    \textit{L'hypothèse généralisée du
    continu et l'axiome du choix.}
    Fundamenta Mathematicae 34.1 (1947): pp.
    1-5} \bibitem{Specker}{Specker, E., {\em
    Verallgemeinerte Kontinuumshypothese und
    Auswahlaxiom.} Archiv der Mathematik 5
    (1954), 332-337}
    \bibitem{Tarski} {Tarski, A., {\em Sur
    quelques th{\'e}or{\`e}mes qui
    {\'e}quivalent {\`a} l'axiome du choix.}
    Fundamenta Mathematicae 5.1 (1924): pp
    147--154.} \bibitem{Zer1904}{Zermelo, E.
    \textit{Beweis, da\ss~jede Menge
    wohlgeordnet werden kann (Aus einem an
    Herrn Hilbert gerichteten Briefe)},
    Math. Ann. \textbf{59} (1904), 514-516;
    translated in: Van Heijenoort, 139-141.}
    \bibitem{Zer1908}{Zermelo, E.
    \textit{Neuer Beweis für die Möglichkeit
    einer Wohlordnung}. Math. Ann.
    \textbf{65} (1908), 107-128; translated
    in: Van Heijenoort, 183-198.}
    \bibitem{Zer1908a}{Zermelo, E.
    \textit{Untersuchungen über die
    Grundlagen der Mengenlehre. I}. Math.
    Ann. \textbf{65} (1908), 261-281;
    translated in: Van Heijenoort, 199-215.}
    \end{thebibliography}
\bigskip
