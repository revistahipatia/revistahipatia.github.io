...
exploramos a interseção entre esses domínios,
...
os autores (Maiara Santos e este editor) exploram 
...
transformações isométricas. Essa é a primeira vez que
a \textsc{Revista de Matemática Hipátia} publica
um artigo de pesquisa em ensino de matemática, 
pesquisa esta conduzida no escopo do PROFMAT/UFBA (Mestrado Profissional
...
Na tradicional seção \textsc{Problema}, 
apresentamos a resolução dos desafios da edição 
anterior, com destaque para as soluções enviadas 
por nossos leitores, e propomos novos problemas 
...
coletivo Ondjango Asili (jogos africanos), além de grandes 
eventos como a Semana Olímpica da OBM e as cerimônias 
de premiação da OBMEP e da OMEBA.
