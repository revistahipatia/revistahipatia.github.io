...
estudaram na Instituição\footnote{As entrevistas mencionadas ocorreram
  ...
  (RIOS, 2012). As fotografias utilizadas no artigo são parte
do acervo pessoal da professora.}.
...
Geral, no primeiro semestre de 1961, e disciplinas no Ensino Superior, como a de Topologia,
em 1964.
...
docente da UFBA e é apontada nas memórias dos estudantes como uma
...
1976 quando os professores da UFBA que ali atuavam foram realocados em
...
\begin{quote}
{[}...{]} \emph{quando o Colégio de Aplicação acabou eu fui chamada para
ir para o Instituto de Matemática, porque todos os professores tomaram seus
destinos, então, pela minha capacidade, pela habilidade, ao invés de ir
para a Educação, porque eu poderia ter ido para a Educação, eu fui para o
...
comecei a ensinar no Colégio de Aplicação. Porque eu substituí a
...
cursos, foi ela quem me indicou e tudo, ela me... animou para ir para o
...
fazia me indicar, só dizia assim: ``para ensinar só Maria Augusta''. Eu
...
meio do Colégio, isso para mim era empolgante, né?!
...
Dantas, foi aí que eu introduzi esse livro, foi um achado para mim, ele
...
dos primeiros, pena que eu não tenha ninguém assim para quem eu possa
...
havia tempo para amadurecer. O Catunda, que era o pai da ideia, ele...
...
homotetia e que translações foram feitas da fundamental para se chegar
aqui...
...
professora que estava fazendo umas experiências, uma maneira de introduzir
os assuntos, mas ela não teve o sucesso esperado por falta de estímulo
para os professores...

Mas, esse livro, uma espécie de tradução de um livro americano,
...
entregava para eles e aquele material é que eles estudavam, que eles
...
que Martha redigiu. Ele não ia mais, mas dava orientações. Nós nos
...
lugar, íamos para casa dela. O trabalho era feito lá.
...
completo, eu não tinha nem... para falar francamente, eu não tinha nem
...
está na primeira fila, no centro da foto com camisa estampada.}
\end{figure*}
...
Teoria de Conjuntos todo... e lá no Colégio de Aplicação nós começamos a
...
aprendizado. Foi muito eficiente para eles, em vez de ser aquele conteúdo
...
acho que facilitou para eles terem estudado a parte da Teoria de
...
isso só fez ajudar e para quem não conhecia de outra forma era muito mais
fácil aprender, muito mais fácil. De modo que para mim foi muito
gratificante.
...
do que eu, porque eu tava ``caducando já naquele assunto'', né?! Estava
...
\end{center}
\caption{A prof.\superau  Maria Augusta entre os estudantes do CA.}
\end{figure*}
...
chamada, então, ela deixou para lá. ``Bom dia, bom dia, bom dia...'',
...
perguntou para mim dessa vez que a gente se encontrou, em dezembro do ano
...
Outro dia eu perguntei à Maria Augusta: ``Maria Augusta, como é que você
...
inflexível, que não dava essa abertura para contestar, nem para tirar
...
penúltima. Rapaz, aquilo era um delírio para a gente, a mulher era uma das
...
Isso era a Matemática da 8\superau  série! Isso mexia com a gente para caramba e,
...
tinha que usar a lógica, os teoremas, usar as teorias da Matemática para
