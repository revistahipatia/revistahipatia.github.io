...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.65\linewidth]{hipatia_pentagono1.png}
...
\end{problem*}
\begin{center}
\includegraphics[width=0.85\linewidth]{tikz_circulo_abcd.png}
\end{center}
...
\includegraphics[width=0.85\linewidth]{tikz_trapezio_esboco1.png}
...
\includegraphics[width=0.85\linewidth]{tikz_trapezio_esboco2.png}
...
\includegraphics[width=0.85\linewidth]{tikz_quadrilatero_fypx.png}
